...
const ArticlesBanner = () => {
  return (
    <div className="relative bg-slate-900">
      {/* Banner Section */}
      <section className="relative h-[36vh] xs:h-[44vh] sm:h-[60vh] md:h-[55vh] lg:h-[50vh] flex items-center justify-center overflow-visible">
        {/* Background Image */}
...
ArticlesBanner.displayName = 'ArticlesBanner';

export default memo(ArticlesBanner);
